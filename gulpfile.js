...
var cssVerticalRhythm = require('postcss-vertical-rhythm-function');
...
var reporter = require('postcss-reporter')({plugins: ['!postcss-discard-empty']});
...
// PostCSS Functions
var postCssFunctions = functions({
  functions: {
    em: function(pixels) {
      var browserContext = 16;
      var pixels = parseInt(pixels, 10);
      return pixels/browserContext;
    }
  }
});
